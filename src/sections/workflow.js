...
const workflowData = [
  {
    title: 'Munchkin Launch',
    text:
      'Initial Munchkin Launch, website development, initial marketing.',
  },
  {
    title: 'Munchkin is growing',
    text:
      'Expansion of the marketing to twitter, tiktok and youtube. Ads on poocoin and 4chan. Applying for CMC & CG',
  },
  {
    title: 'Stable Munchkin',
    text:
      'Want more munchkins? Staking coming in third phase.',
  },
  {
    title: 'Munchkin is Big now',
    text:
      'Developing cat-care dapp, managed by DAO.',
  },
];

const WorkFlow = () => {
  return (
    <Box as="section" id="roadmap"  sx={styles.workflow}>
      <Container>
        <BlockTitle
          sx={styles.workflow.blockTitle}
          tagline="Roadmap"
          heading="Let’s see what we have for the future"
        />
