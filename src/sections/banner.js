        ...
        <Flex sx={styles.banner.row}>
          <Box sx={styles.banner.col}>
            <Box sx={styles.banner.content}>
              ...
              <Text as="p">
                Hold Munchkin and earn more Munchkin <br />
                Ready to become the new biggest cat coin in bsc space!<br />
                Simply love, pet, and hold Munchkin tokens in your wallet
              </Text>
